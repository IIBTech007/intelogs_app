...
//                  title: Text(categoryList[index]['section_name'].toString()!=null?categoryList[index]['section_name'].toString():''),
//                  subtitle: Column(
//                    mainAxisAlignment: MainAxisAlignment.center,
//                    children: <Widget>[
//                      Text(categoryList[index]['emp_name'].toString()!= null?categoryList[index]['emp_name'].toString():''),
//                      Text(categoryList[index]['section_code'].toString()!= null?"Code:"+categoryList[index]['section_code'].toString():''),
//                    ],
//                  ),
...
//                  onTap: ()async{
//                    // Navigator.push(context, MaterialPageRoute(builder: (context) => SkillsGroupDetails("jP1RYdAj",sectionList[index])),);
//                  },
//                ),
