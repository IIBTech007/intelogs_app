...
class AddEmployeeToShift extends StatefulWidget{
  String token;

  AddEmployeeToShift(this.token);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _AddEmployeeToShift_State(token);
  }

}

class _AddEmployeeToShift_State extends State<AddEmployeeToShift> {
  String token;

  _AddEmployeeToShift_State(this.token);
