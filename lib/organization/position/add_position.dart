...
class AddPosition extends StatefulWidget{
  ...
  AddPosition(this.token);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _AddPosition_State(token);
  }

}

class _AddPosition_State extends State<AddPosition>{
  String token;
  _AddPosition_State(this.token);
  ...
  void initState() {
    ...
    super.initState();
    position_name = TextEditingController();
