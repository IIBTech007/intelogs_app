...
class AddAssetGroup extends StatefulWidget{
  String token;

  AddAssetGroup(this.token);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _AddAssetGroup_State(token);
  }

}

class _AddAssetGroup_State extends State<AddAssetGroup>{
  String token;
  ...
  _AddAssetGroup_State(this.token);
